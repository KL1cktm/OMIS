...
public class AdminAnalystProblemsController {
    @Autowired
    ...
    @GetMapping("/analyst_problems")
    public String analystProblems(Model model) {
        ...
        return "admin/analyst_problems";
    }

    @PostMapping("/chooseCategoryForAnalyst")
    public String chooseCategoryForAnalyst(@RequestParam("categoryName") String category, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/admin/analyst_problems";
    }
}
